...
self.addEventListener("install", function (e) {
  e.waitUntil(
    caches.open(CACHE).then(function (c) {
      return c.addAll(["./", "./index.html", "./manifest.webmanifest", "./weights.js", "./weight-sync.js", "./health-schema.js", "./health-data.js", "./health-view.js", "./analytics-math.js", "./analytics-store.js", "./analytics-view.js", "./bike-view.js", "./dashboard.js", "./dashboard.css"]);
